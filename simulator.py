...
class faas_Model():
    ...
    def __init__(self, faas_data_path='NULL'):
        ...
        self.theta_fiducial = np.concatenate((np.array(
            [8.886491e+00, 7.924279e+00, 1.050515e+01, 7.397940e+00, -3.682371e+00, -4.509306e+00, -6.162727e+00,
             -6.585027e+00, 1.100000e-03, -3.900000e-01]), np.array([0] * 94)))
    ...
    def forward(self, th, seed):
        ...
        theta = pd.Series(th)
        theta.index = ['logK_on_TN', 'logK_on_TC', 'logK_on_RN', 'logK_on_RC', 'logK_D_TN', 'logK_D_TC', 'logK_D_RN',
                       'logK_D_RC', 'm_alpha', 'alpha0'] + ['epsilon' + str(i) for i in np.arange(0, 94)]
    ...
    def compressor(self, d):
        ...
        for i in d:
            ...
            comp_d.append(
                [time_peak, diff_peak_final, diff_peak_first, diff_first_final, diff_first_mid, diff_final_mid])
